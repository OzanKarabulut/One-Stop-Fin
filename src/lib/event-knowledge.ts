...
export interface EventDetail {
  ...
  tarihsel: string;
  opsiyon: string;
  volProfile?: "vol_up" | "iv_crush" | "neutral";
  sellerNote?: string;
}
...
export const EVENT_KNOWLEDGE: Partial<Record<EventType, EventDetail>> = {
  cpi: {
    ...
    volProfile: "vol_up",
    sellerNote: "Prim satıcısı: CPI öncesi satma, IV crush sonrası gir",
  },
  ppi: {
    ...
    volProfile: "vol_up",
    sellerNote: "CPI ile aynı haftaysa dikkat — birleşik IV şişmesi",
  },
  pce: {
    ...
    volProfile: "vol_up",
    sellerNote: "Ay sonu PCE + rebalancing çakışması — vade seçimine dikkat",
  },
  nfp: {
    ...
    volProfile: "vol_up",
    sellerNote: "Cuma gap riski — haftalık put satarken NFP'yi vade içine alma",
  },
  fomc: {
    ...
    volProfile: "vol_up",
    sellerNote: "FOMC öncesi IV şişer, karar sonrası crush — klasik straddle satış fırsatı",
  },
  "triple-witching": {
    ...
    volProfile: "vol_up",
    sellerNote: "Gamma unwind — vade haftası pin etkisi, sonrası hareket genişler",
  },
  opex: {
    ...
    volProfile: "vol_up",
    sellerNote: "OPEX haftası pinning, sonrasında gamma boşalır — yeni pozisyon için bekle",
  },
  "vix-expiry": {
    ...
    volProfile: "vol_up",
    sellerNote: "Vol-of-vol oynaklığı — kısa süreli VIX spike mümkün",
  },
  "jpm-collar": {
    ...
    volProfile: "neutral",
    sellerNote: "Çeyrek sonu roll akışı — collar strike'larını destek/direnç olarak izle",
  },
  "russell-recon": {
    ...
    volProfile: "neutral",
    sellerNote: "Kapanış hacmi yüksek — Russell isimlerinde spread genişleyebilir",
  },
  holiday: {
    ...
    volProfile: "neutral",
    sellerNote: "Tatil = ince likidite, theta çalışır ama spread geniş",
  },
};
